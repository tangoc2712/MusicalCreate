// const C4 = new Audio("sounds/drum.mp3");
// const Db4 = new Audio("sounds/random21.wav");
...
// const E6 = new Audio("D:Y3Web_self_practiceMusicalCreatesoundsB4.mp3");

// const playSound = (audio) => {
//   const clone = audio.cloneNode();
//   clone.play();
//   setTimeout(() => (clone.volume = 1), 200);
//   setTimeout(() => (clone.volume = 0.8), 400);
//   setTimeout(() => (clone.volume = 0.6), 800);
//   setTimeout(() => (clone.volume = 0.4), 1200);
//   setTimeout(() => (clone.volume = 0.2), 1600);
//   setTimeout(() => (clone.volume = 0.1), 200000000);
// };
...
function sequencer() {
  const kick = new Tone.Player("../sounds/A4.mp3").toMaster();
  const snare = new Tone.Player("../sounds/drum.mp3").toMaster();
  let index = 0;
